...
const { startGrpcServer } = require('./grpc/article-service');
const { connectProducer, connectConsumer } = require('./kafka/article-events');
...
app.get('/health', (req, res) => {
  res.status(200).json({ status: 'UP', service: 'article-service' });
});
